...
class SupervisorController {
   ...
   */
  Future<Supervisor> fetchSup(String email, String staffNo,
      {urlViewSupProfile = 'http://10.100.15.38/viewSupProfile.php',
      urlViewSupStaffNo = 'http://10.100.15.38/viewSupStaffNo.php'}) async {
   ...
   */
  Future setUserSup(String email,
      {urlViewSupProfile = 'http://10.100.15.38/viewSupProfile.php',
      urlReadBoards = 'http://10.100.15.38/ReadBoards.php',
      urlViewSupStaffNo = 'http://10.100.15.38/viewSupStaffNo.php'}) async {
    supervisor = await fetchSup(email, null,
        urlViewSupProfile: urlViewSupProfile,
        urlViewSupStaffNo: urlViewSupStaffNo);
...
//
  ...
  /*
    ...
    as different data is required to be passed in.
     ...
     successful.
   */
  Future<String> registration(Supervisor supervisorA, User userA,
      {url = 'http://10.100.15.38/Register_Supervisor.php',
    ...
    userRegistrationMessage =
        await userController.userRegistration(userA, url: url2);
